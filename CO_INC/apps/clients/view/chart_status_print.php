<table border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td valign="top"><?php echo($chart["title"]);?><br />
<img src="<?php echo(CO_PATH_BASE);?>/data/charts/<?php echo($chart["img_name"]);?>" alt="<?php echo($chart["title"]);?>" width="150" height="90" title="<?php echo($chart["title"]);?>"/><br />
        ...
        <td><table border="0" cellspacing="0" cellpadding="0" class="smalltext">
    <tr>
        ...
        <td>&nbsp;</td>
        <td><?php echo $lang["CLIENT_STATUS_PLANNED_TEXT"];?></td>
    </tr>
    <tr>
        ...
        <td>&nbsp;</td>
        <td><?php echo $lang["CLIENT_STATUS_INPROGRESS_TEXT"];?></td>
    </tr>
    <tr>
        ...
        <td>&nbsp;</td>
        <td><?php echo $lang["CLIENT_STATUS_FINISHED_TEXT"];?></td>
    </tr>
    <tr>
        <td><span class="barchart_color_not_finished" style="padding: 0 4px; text-align: right; margin-right: 3px;"><?php echo($chart["stopped"]);?>%</span></td>
        <td>&nbsp;</td>
        <td><?php echo $lang["CLIENT_STATUS_STOPPED_TEXT"];?></td>
    </tr>
</table></td>
    </tr>
</table>
