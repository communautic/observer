...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left-inactive text11"><?php echo $lang["EVAL_COMMENTS"];?></td>
...
<?php foreach ($arr["comments"] as $comment) { ?>
	...
	<tr>
		<td class="tcell-left text11"><span><?php echo $lang["EVAL_COMMENT_TITLE"];?></span></td>
		<td class="tcell-right"><?php echo($comment->title);?></td>
        <td width="25"><a href="evals_comments" class="binRestore" rel="<?php echo $comment->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="evals_comments" class="binDelete" rel="<?php echo $comment->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left-inactive text11"><?php echo $lang["EVAL_COMMENT_GOALS"];?></td>
    <td class="tcell-right">&nbsp;</td>
    </tr>
</table>
<?php foreach ($arr["comments_tasks"] as $comment_task) { ?>
	...
	<tr>
        ...
        <td width="25"><a href="evals_comments" class="binRestoreItem" rel="<?php echo $comment_task->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="evals_comments" class="binDeleteItem" rel="<?php echo $comment_task->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
		<td class="tcell-left text11"><span><?php echo $lang["DELETED_BY_ON"];?></span></td>
