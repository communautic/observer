...
<div id="forumsPost_<?php echo $post->id;?>" style="border-bottom: 1px solid #436593">
  ...
  <tr>
      	...
      	<table border="0" cellpadding="0" cellspacing="0">
      		<tr>
                ...
                <td width="27" style="padding-top: 4px;">
                    ...
                    <?php if($forum->canedit) { ?><a class="postForumsReply" title="antworten" rel="<?php echo $post->id;?>"><span class="icon-reply"></span></a><?php } ?>
                </td>
      		</tr>
      	</table>
      </td>
      <td class="tcell-right-nopadding">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td class="text11"><div class="text13" style="margin-left: 7px; padding: 0 15px 15px 0;"><div id="forumsPostanswer_<?php echo $post->id;?>"><?php echo $post->text;?></div></div></td>
            </tr>
          </table>
  		</td>
