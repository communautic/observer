...
<table border="0" cellpadding="0" cellspacing="0" class="table-content tbl-protocol">
  <tr>
    <td style="width: 40px;"><span class="<?php if($treatment->canedit) { ?>selectTextarea<?php } ?>"><span><div class="circle circle<?php echo $curcol;?>"><div><?php echo $i;?></div></div></span></span></td>
