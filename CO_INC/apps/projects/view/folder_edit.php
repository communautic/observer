...
<?php } ?>
<div id="projectsFoldersTabs" class="contentTabs">
	<ul class="contentTabsList">
		<li><span class="active" rel="FolderDetailsList"><?php echo $lang["PROJECT_FOLDER_TAB_PROJECTS"];?></span></li>
		<li><span rel="FolderDetailsMultiView"><?php echo $lang["PROJECT_FOLDER_TAB_MULTIVIEW"];?></span></li>
        <?php if($folder->access == "sysadmin") { ?>
		<li><span rel="FolderDetailsStatus"><?php echo $lang["PROJECT_FOLDER_TAB_STATUS"];?></span></li>
        <?php } ?>
	</ul>
    <div id="projectsFoldersTabsContent" class="contentTabsContent">
