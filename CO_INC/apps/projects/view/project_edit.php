...
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
	  <td class="tcell-left text11"><a href="#" class="content-nav ui-datepicker-trigger-action"><span><?php echo PROJECT_KICKOFF;?></span></a></td>
...
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
	  <td class="tcell-left text11"><a href="#" class="content-nav showDialog" request="getProjectFolderDialog" field="projectfolder" append="1"><span><?php echo PROJECT_FOLDER_RIGHT;?></span></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
	  <td class="tcell-left text11"><a href="#" class="content-nav showDialog" request="getContactsDialog" field="management" append="1"><span><?php echo PROJECT_MANAGEMENT;?></span></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
  <tr>
    <td class="tcell-left text11"><a href="#" class="content-nav showDialog" request="getContactsDialog" field="team" append="1"><span><?php echo PROJECT_TEAM;?></span></a></td>
...
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
	  <td class="tcell-left text11"><a href="<?php echo $lang["GLOBAL_STATUS"];?>" class="content-nav showDialog" request="getProjectStatusDialog" field="status" title="<?php echo $lang["GLOBAL_STATUS"];?>" append="1"><span><?php echo $lang["GLOBAL_STATUS"];?></span></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content tbl-protocol">
	<tr>
		<td class="tcell-left text11"><a href="#" class="content-nav protocolToggle"><span><?php echo PROJECT_DESCRIPTION;?></span></a></td>
