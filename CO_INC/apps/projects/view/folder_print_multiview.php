...
<div style="position: absolute; width: 177px; top: <?php echo $ltop; ?>px; left: 0px; padding: 1px 0 0 10px; height: 15px; background-color: #b2b2b2; vertical-align: top; font-size: 12px; line-height: 16px; overflow: hidden;"><?php echo $project->title;?></div>

<div style="position: absolute; width: 28px; top: <?php echo $ltop; ?>px; left: 189px; text-align: right;  padding: 1px 10px 0 0;  height: 15px; background-color: #b2b2b2; vertical-align: top; font-size: 12px; line-height: 16px;"><?php echo $project->days;?></div>

<div style="position: absolute; width: 120px; top: <?php echo $ltop+18; ?>px; left: 0px; padding: 1px 0 0 10px; height: 15px; vertical-align: top; font-size: 10px; line-height: 16px; overflow: hidden;"><?php echo($project->startdate);?>-<?php echo($project->enddate);?></div>
<div style="position: absolute; width: 100px; top: <?php echo $ltop+18; ?>px; left: 120px; text-align: right;  padding: 1px 10px 0 0;  height: 15px; vertical-align: top; font-size: 10px; line-height: 16px; overflow: hidden;"><?php echo($project->name);?></div>
...
<!-- project loop -->
				...
				if($project->kickoff_only) { ?>
					<div style="z-index: 2; position: absolute; top: <?php echo($project->css_top+$top+15);?>px; left: <?php echo($project->css_left+$left+$project->kickoff_space);?>px; height: 16px; width: 16px;"><img src="<?php echo CO_FILES;?>/img/kickoff.png" width="16" height="16" alt="" /></div>
				<?php } else {
				?>
                
                <div class="<?php echo($project->status);?>" style="z-index: 2; position: absolute; top: <?php echo($project->css_top+$top+15);?>px; left: <?php echo($project->css_left+$left);?>px; height: 20px; width: <?php echo($project->css_width);?>px;"><?php echo($project->realisation["real"]);?>%</div>
...
<div style="position: absolute; width: <?php echo($folder->page_width-24);?>px; top: <?php echo $folder->css_height+150;?>px; left: 0px; height: 19px;  background-color: #e5e5e5; vertical-align: top; padding: 3px 0 0 24px;"><?php echo $lang["PROJECT_TIMELINE_PROJECT_PLAN"];?></div>
