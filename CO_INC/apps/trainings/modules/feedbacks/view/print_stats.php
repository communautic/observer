<table width="100%" class="title grey">
	<tr>
        <td class="tcell-left"><?php echo $lang["TRAINING_FEEDBACK_TITLE_STATISTICS"];?></td>
...
<table width="100%" class="standard-margin">
	<tr>
		<td width="34%"><?php  $this->getChart($feedback->pid,'registrations', $feedback->total_regs,1);?></td>
		<td width="33%"><?php  $this->getChart($feedback->pid,'attendees', $feedback->total_attendees,1);?></td>
		<td width="33%"><?php  $this->getChart($feedback->pid,'feedbacks', $feedback->total_result,1);?></td>
	</tr>
</table>
&nbsp;<br />
