...
<div style="position: absolute; width: 163px; top: <?php echo $top; ?>px; left: 0px; padding: 1px 0 0 24px; height: 15px; vertical-align: top; font-size: 10px; line-height: 16px;"><?php echo $lang['TRAINING_TIMELINE_ACTION'];?></div>
<div style="position: absolute; width: 28px; top: <?php echo $top; ?>px; left: 189px; text-align: right;  padding: 1px 10px 0 0;  height: 15px;  vertical-align: top; font-size: 10px; line-height: 16px;"><?php echo $lang['TRAINING_TIMELINE_TIME'];?></div>
...
<div style="position: absolute; width: 177px; top: <?php echo $ltop; ?>px; left: 0px; padding: 1px 0 0 10px; height: 15px; background-color: #b2b2b2; vertical-align: top; font-size: 12px; line-height: 16px; overflow: hidden;"><?php echo $training->title;?></div>

<div style="position: absolute; width: 28px; top: <?php echo $ltop; ?>px; left: 189px; text-align: right;  padding: 1px 10px 0 0;  height: 15px; background-color: #b2b2b2; vertical-align: top; font-size: 12px; line-height: 16px;"><?php echo $training->days;?></div>

<div style="position: absolute; width: 120px; top: <?php echo $ltop+18; ?>px; left: 0px; padding: 1px 0 0 10px; height: 15px; vertical-align: top; font-size: 10px; line-height: 16px; overflow: hidden;"><?php echo($training->startdate);?>-<?php echo($training->enddate);?></div>
<div style="position: absolute; width: 100px; top: <?php echo $ltop+18; ?>px; left: 120px; text-align: right;  padding: 1px 10px 0 0;  height: 15px; vertical-align: top; font-size: 10px; line-height: 16px; overflow: hidden;"><?php echo($training->name);?></div>
...
<!-- training loop -->
                ...
                <div class="<?php echo($training->status);?>" style="z-index: 2; position: absolute; top: <?php echo($training->css_top+$top+15);?>px; left: <?php echo($training->css_left+$left);?>px; height: 20px; width: <?php echo($training->css_width);?>px;">&nbsp;</div>
                
                <?php 
				} ?>

            
<div style="position: absolute; width: <?php echo($folder->page_width-24);?>px; top: <?php echo $folder->css_height+150;?>px; left: 0px; height: 19px;  background-color: #e5e5e5; vertical-align: top; padding: 3px 0 0 24px;"><?php echo $lang["TRAINING_TIMELINE_TRAINING_PLAN"];?></div>
...
<div style="position: absolute; width: <?php echo($folder->css_width+$left);?>px; top: <?php echo $folder->css_height+180;?>px; left: 0px; height: 19px; vertical-align: top; padding: 3px 0 0 24px;"><img src="<?php echo(CO_FILES);?>/img/print/<?php echo $GLOBALS["APPLICATION_LOGO_PRINT"];?>" width="135" height="9" /></div>