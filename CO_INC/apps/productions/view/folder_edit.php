...
<?php } ?>
<div id="productionsFoldersTabs" class="contentTabs">
	<ul class="contentTabsList">
		<li><span class="active" rel="FolderDetailsList"><?php echo $lang["PRODUCTION_FOLDER_TAB_PRODUCTIONS"];?></span></li>
		<li><span rel="FolderDetailsMultiView"><?php echo $lang["PRODUCTION_FOLDER_TAB_MULTIVIEW"];?></span></li>
        <?php if($folder->access == "sysadmin") { ?>
		<li><span rel="FolderDetailsStatus"><?php echo $lang["PRODUCTION_FOLDER_TAB_STATUS"];?></span></li>
        <?php } ?>
	</ul>
    <div id="productionsFoldersTabsContent" class="contentTabsContent">
