...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
  <tr>
    <td class="tcell-left text11"><span class="<?php if($document->canedit) { ?>content-nav focusTitle<?php } ?>"><span><?php echo $lang["PRODUCTION_DOCUMENT_TITLE"];?></span></span></td>
...
<div id="productions_documents_uploader" class="document-uploader">		
	<noscript>			
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content tbl-inactive">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="tcell-left text11"><?php echo $lang["PRODUCTION_DOCUMENT_FILENAME"];?></td>
      <td class="tcell-right"><a mod="productions_documents" class="downloadDocument" rel="<?php echo $value->id;?>"><?php echo($value->filename)?></a></td>
 	  <td width="30"><?php if($document->canedit) { ?><a class="binItem" rel="<?php echo $value->id;?>"><span class="icon-delete"></span></a><?php } ?></td>
    </tr>
    <tr>
      <td class="tcell-left text11"><?php echo $lang["PRODUCTION_DOCUMENT_FILESIZE"];?></td>
...
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
	  <td class="tcell-left text11"><span class="<?php if($document->canedit) { ?>content-nav showDialog<?php } ?>" request="getAccessDialog" field="productionsdocument_access" append="1"><span><?php echo $lang["GLOBAL_ACCESS"];?></span></span></td>
        <td class="tcell-right"><div id="productionsdocument_access" class="itemlist-field"><div class="listmember" field="productionsdocument_access" uid="<?php echo($document->access);?>" style="float: left"><?php echo($document->access_text);?></div></div></td>
	</tr>
</table>
<div class="content-spacer"></div>
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		...
		<td class="tcell-right-inactive tcell-right-nopadding"><div id="productionsdocument_sendto">
        <?php 
