<table width="100%" class="title">
	<tr>
        <td class="tcell-left"><?php echo $lang["PRODUCTION_TIMELINE_DATES_LIST"];?></td>
        <td>&nbsp;</td>
	</tr>
</table>
...
if($numPhases > 0) {
    ...
    <table width="100%" class="standard-grey">
        <tr>
            ...
            <td><?php echo($countPhases . ". " . $production["phases"][$key]["title"]);?></td>
        </tr>
    </table>
    <table width="100%" class="standard-grey">
        <tr>
            <td class="tcell-left">&nbsp;</td>
            <td class="smalltext grey"><?php echo($production["phases"][$key]["startdate"]);?> - <?php echo($production["phases"][$key]["enddate"]);?></td>
        </tr>
    </table>
	<?php
		...
		<table width="100%" class="fourCols">
            <tr>
                ...
                <td class="fourCols-four"><?php echo($production["phases"][$key]["tasks"][$tkey]["text"]);?></td>
            </tr>
            <tr>
                <td class="fourCols-one">&nbsp;</td>
                <td class="fourCols-two">&nbsp;</td>
