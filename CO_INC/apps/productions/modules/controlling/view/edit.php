...
<table border="0" cellspacing="0" cellpadding="0" class="table-title grey">
  <tr>
    <td nowrap="nowrap" class="tcell-left text11"><span class="content-nav-title"><?php echo $lang["PRODUCTION_CONTROLLING_STATUS"];?></span></td>
    <td></td>
  </tr>
</table>
</div>
...
<div style="position: relative; float: left; width: 150px; margin: -26px 9px 0 9px">
  ...
  <tr>
    <td class="text11" style="padding: 3px 0 0 8px;" width="120"><?php echo $lang["PRODUCTION_CONTROLLING_PHASES_CREATED"];?></td>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="text11" style="padding: 3px 0 0 8px" width="120"><?php echo $lang["PRODUCTION_CONTROLLING_PHASES_PLANNED"];?></td>
    <td class="text11" style="text-align: right; padding: 3px 7px 0 0"><?php echo($controlling->plannedphases);?></td>
  </tr>
</table>
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="text11" style="padding: 3px 0 0 8px" width="120"><?php echo $lang["PRODUCTION_CONTROLLING_PHASES_RUNNING"];?></td>
    <td class="text11" style="text-align: right; padding: 3px 7px 0 0"><?php echo($controlling->inprogressphases);?></td>
  </tr>
</table>
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td class="text11" style="padding: 3px 0 0 8px" width="120"><?php echo $lang["PRODUCTION_CONTROLLING_PHASES_FINISHED"];?></td>
