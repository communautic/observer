...
class MySQLDB
{
   ...
   function confirmUserID($username, $userid){
      ...
      /* Verify that user is in database */
      $q = "SELECT userid FROM ".CO_TBL_USERS." WHERE username = '$username'";
      $result = mysql_query($q, $this->connection);
      if(!$result || (mysql_numrows($result) < 1)){
         return 1; //Indicates username failure
      }
   ...
   function usernameTaken($username){
      ...
      $q = "SELECT username FROM ".CO_TBL_USERS." WHERE username = '$username'";
      $result = mysql_query($q, $this->connection);
   ...
   function updateUserField($username, $field, $value){
      $q = "UPDATE ".CO_TBL_USERS." SET ".$field." = '$value' WHERE username = '$username'";
      return mysql_query($q, $this->connection);
   }
   ...
   function getUserInfo($username){
      $q = "SELECT * FROM ".CO_TBL_USERS." WHERE username = '$username'";
      $result = mysql_query($q, $this->connection);
