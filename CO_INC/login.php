...
<div id="login-outer"><form id="com-form" name="com_form" method="post" action="<?php echo CO_PATH_URL."/process.php";?>">
<input type="hidden" name="sublogin" value="1" /><div class="bar-outer"><table width="493" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="121" valign="top" class="login-text"><?php echo(LOGIN_USERNAME);?></td>
    <td width="320" valign="top"><input type="text" name="user" class="com-input" /></td>
    <td width="52" valign="top"><div id="loginFailed" class="popup"><div class="popup-inner"><?php echo(LOGIN_LOGIN_FAILED);?></div></div><div id="System" class="popup">
      <div class="popup-inner"><?php echo(LOGIN_REQUIREMENTS_DETAILS);?></div></div></td>
  </tr>
  </table></div>
  <div class="bar-outer"><table width="493" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="121" valign="top" class="login-text"><?php echo(LOGIN_PASSWORD);?></td>
    <td valign="top"><input type="password" name="pass" class="com-input" /></td>
    <td valign="top" class="right"><input type="submit" name="button" id="button" value="<?php echo(LOGIN_LOGIN);?>" /></td>
  </tr>
  </table></div>
  <div style="height: 106px"><table width="493" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="235" valign="top" class="login-text"><?php echo(LOGIN_REMEMBER);?></td>
        <td width="30" class="login-text"><input type="checkbox" name="remember" value="yes" /></td>
        <td valign="top" class="login-text right"><a href="#" class="System-hover"><?php echo(LOGIN_REQUIREMENTS);?></a></td>
      </tr>
    </table></div>
    <table width="493" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
    <td colspan="3" valign="top" class="login-copyright"><?php echo(LOGIN_COPYRIGHT);?></td>
    </tr>
</table></form>
</div>
</body>
