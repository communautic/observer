...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
  <tr>
    <td class="tcell-left text11"><span class="<?php if($sketch->canedit) { ?>content-nav focusTitle<?php } ?>"><span><?php echo $lang["PROJECT_SKETCH_TITLE"];?></span></span></td>
...
<?php } ?>
        ...
        <div class="canvasTools">
            ...
            <span class="addTool" title="<?php echo $lang["PROJECT_SKETCH_ACTION_NEW"];?>"></span>
            <span class="penTool active" title="<?php echo $lang["PROJECT_SKETCH_ACTION_DRAW"];?>"></span>
            <span class="erasorTool" title="<?php echo $lang["PROJECT_SKETCH_ACTION_DELETE"];?>"></span>
            <?php if($sketch->type == 2) { ?><span class="rotateTool" title="<?php echo $lang["PROJECT_SKETCH_ACTION_ROTATE"];?>"></span><?php } ?>
            <span class="clearTool" title="<?php echo $lang["PROJECT_SKETCH_ACTION_CLEAR"];?>"></span>
            <span class="undoTool" title="<?php echo $lang["PROJECT_SKETCH_ACTION_UNDO"];?>"></span>
            <?php } ?>
        </div>
        </div>
        <?php
		switch($sketch->type) {
			...
			break;
			case 1:
				if(defined('CO_PROJECT_SKETCHES_CUSTOM')) { 
...
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
	  <td class="tcell-left text11"><span class="<?php if($sketch->canedit) { ?>content-nav showDialog<?php } ?>" request="getAccessDialog" field="projectssketch_access" append="1"><span><?php echo $lang["GLOBAL_ACCESS"];?></span></span></td>
        <td class="tcell-right"><div id="projectssketch_access" class="itemlist-field"><div class="listmember" field="projectssketch_access" uid="<?php echo($sketch->access);?>" style="float: left"><?php echo($sketch->access_text);?></div></div><input type="hidden" name="sketch_access_orig" value="<?php echo($sketch->access);?>" /></td>
	</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left-inactive text11"><?php echo $lang["GLOBAL_EMAILED_TO"];?></td>
		<td class="tcell-right-inactive tcell-right-nopadding"><div id="projectssketch_sendto">
        <?php 
