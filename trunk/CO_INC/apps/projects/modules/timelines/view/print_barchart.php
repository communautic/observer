...
<div style="position: absolute; top: <?php echo($top+18);?>px; left: <?php echo($left);?>px; background-image:url(<?php echo($project["bg_image"]);?>); background-position: <?php echo($project["bg_image_shift"]);?>px 0px; width: <?php echo($project["css_width"]);?>px; height:<?php echo($project["css_height"]);?>px;"></div>
	<!-- kick off -->
	<div style="z-index: 2; background-color: #B2B2B2; position: absolute; top: <?php echo($top+18+8);?>px; left: <?php echo($left);?>px; height: 10px; width: <?php echo($project["td_width"]);?>px; font-size: 11px;"></div>
...
<div style="position: absolute; width: <?php echo($project["page-width"]-$left);?>px; top: <?php echo $project["css_height"]+148;?>px; left: <?php echo($left-18);?>px; height: 19px; text-align:center;"><table border="0" cellspacing="0" cellpadding="0" class="timeline-legend">
    <tr>
