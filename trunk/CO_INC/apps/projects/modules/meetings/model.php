...
class ProjectsMeetingsModel extends ProjectsModel {
   ...
   function createNew($id) {
   	...
   	function createDuplicate($id) {
		...
		// meeting
		$q = "INSERT INTO " . CO_TBL_PROJECTS_MEETINGS . " (pid,title,item_date,start,end,location,location_ct,length,management,management_ct,participants,participants_ct,created_date,created_user,edited_date,edited_user) SELECT pid,CONCAT(title,' " . $lang["GLOBAL_DUPLICAT"] . "'),item_date,start,end,location,location_ct,length,management,management_ct,participants,participants_ct,'$now','$session->uid','$now','$session->uid' FROM " . CO_TBL_PROJECTS_MEETINGS . " where id='$id'";
		$result = mysql_query($q, $this->_db->connection);
