...
<table border="0" cellpadding="0" cellspacing="0" class="table-content tbl-inactive">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <?php if($phase->canedit) { ?><td width="30"><a class="deleteTask" rel="<?php echo $value->id;?>"><span class="icon-delete"></span></a></td><?php } ?>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="12"></td>
      <td class="tcell-left text11"><span class="<?php if($phase->canedit) { ?>content-nav ui-datepicker-trigger-action<?php } ?>"><span><?php echo $lang["PHASE_TASK_START"];?></span></span></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td class="tcell-left text11"><span class="<?php if($phase->canedit) { ?>content-nav showDialog<?php } ?>" request="getContactsDialog" field="task_team_<?php echo $value->id;?>" append="1"><span><?php echo $lang["PHASE_TASK_TEAM"];?></span></span></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td class="tcell-left text11"><span class="<?php if($phase->canedit) { ?>content-nav showDialog<?php } ?>" request="getTasksDialog" field="dependent<?php echo $value->id;?>" sql="<?php echo $value->id;?>" append="1"><span><?php echo $lang["PHASE_TASK_DEPENDENT"];?></span></span></td>
