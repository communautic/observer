...
<table border="0" cellpadding="0" cellspacing="0" class="table-content tbl-inactive" style="margin-bottom: 0px;">
  <tr>
      	...
      	<table border="0" cellpadding="0" cellspacing="0">
      		<tr>
                ...
                <td width="27" style="padding-top: 4px;">
                	<input name="task[<?php echo $child->id;?>]" type="checkbox" value="<?php echo $child->id;?>" class="cbx jNiceHidden" <?php echo $checked ;?> />
                    <a class="postBrainstormsReply" title="antworten" rel="<?php echo $child->id;?>"><span class="icon-reply"></span></a>
                </td>
      		</tr>
      	</table>
      </td>
      <td class="tcell-right-nopadding">
       ...
       <td width="15"><a class="binItem<?php echo $postdellink;?>" rel="<?php echo $child->id;?>"><span class="<?php echo $postdelclass;?>"></span></a></td>
	</tr>
</table>
</div>