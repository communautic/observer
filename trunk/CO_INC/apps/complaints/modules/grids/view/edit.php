...
<table cellspacing="0" cellpadding="0" border="0" class="table-content">
    ...
    <tr>
        <td class="barchart_color_planned"><span><?php echo $lang["COMPLAINT_GRID_STATUS_PLANED"];?></span></td>
        <td width="15"></td>
...
foreach($cols as $key => &$value){ 
  ...
  <div id="complaints-notes-outer" class="complaints-notes-outer">
      <div id="complaints-grid-note" class="note note-design" style="width: 203px; height: 150px; display: none;">
        ...
        <div id="complaints-grid-note-save" style="position: absolute; top: 9px; right: 10px; width: 15px; height: 15px; cursor: pointer;"><a rel="" class="binItem"><span class="icon-delete"></span></a></div>
        </h3>
