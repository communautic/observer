...
<table width="100%" class="standard">
	<tr>
		<td class="tcell-left"><?php echo $lang["COMPLAINT_GRID_OWNER"];?></td>
		<td class="smalltext"><?php echo($grid->owner_print);?> <?php echo($grid->owner_ct);?></td>
    </tr>
</table>
<table width="100%" class="standard">
	<tr>
		<td class="tcell-left"><?php echo $lang["COMPLAINT_GRID_MANAGEMENT"];?></td>
		<td class="smalltext"><?php echo($grid->management_print);?> <?php echo($grid->management_ct);?></td>
    </tr>
</table>
<table width="100%" class="standard">
	<tr>
		<td class="tcell-left"><?php echo $lang["COMPLAINT_GRID_TEAM"];?></td>
...
<div style="position: absolute; width: 95px; top: <?php echo(64+$varheight);?>px; left: 0px; padding-left: 24px; height: 38px; vertical-align: top; font-size: 10px;"><?php echo $lang["COMPLAINT_GRID_COLUMN_NEW"];?></div>
<div style="position: absolute; width: <?php echo($page_width);?>px; top: <?php echo(96+$varheight);?>px; left: 0px; padding-left: 24px; height: 46px; color: #666666; background-color: #E5E5E5; vertical-align: top; font-size: 10px;"><?php echo $lang["COMPLAINT_GRID_TITLE_MAIN"];?></div>
...
<div style="position: absolute; width: <?php echo($page_width-24);?>px; top: <?php echo $page_height-50;?>px; left: 0px; height: 19px;  background-color: #e5e5e5; vertical-align: top; padding: 3px 0 0 24px;"><?php echo $lang["COMPLAINT_GRID_TITLE"];?></div>
<div style="position: absolute; width: <?php echo($page_width-235);?>px; top: <?php echo $page_height-52;?>px; left: 200px; height: 19px; text-align:center;"><table border="0" cellspacing="0" cellpadding="0" class="timeline-legend">
    <tr>
        <td class="psp_barchart_color_planned"><span><?php echo $lang["COMPLAINT_GRID_STATUS_PLANED"];?></span></td>
        <td width="15"></td>
        <td class="barchart_color_inprogress"><span><?php echo $lang["COMPLAINT_GRID_STATUS_INPROGRESS"];?></span></td>
         <td width="15"></td>
        <td class="barchart_color_finished"><span><?php echo $lang["COMPLAINT_GRID_STATUS_FINISHED"];?></span></td>
    </tr>
</table></div>
