    <div id="note" class="note" style="width: 200px; height: 200px; left: <?php echo $left;?>px; top: <?php echo $top;?>px; font-size: 11px;">
        ...
        <div id="note-info" class="complaintsNoteInfo coTooltip" style="position: absolute; top: 0px; right: 45px; width: 15px; height: 15px; cursor: pointer;"><span class="icon-info"></span>
        ...
        <div id="note-delete" class="complaintsNoteDelete" style="position: absolute; top: 1px; right: 6px; width: 15px; height: 15px; cursor: pointer;"><a class="binItem"><span class="icon-delete"></span></a></div>
        </h3>
