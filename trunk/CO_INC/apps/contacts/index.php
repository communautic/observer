...
if (!empty($_POST['request'])) {
	...
	switch ($_POST['request']) {
		...
		case 'setContactDetails':
			echo($contacts->setContactDetails($_POST['id'], $system->checkMagicQuotes($_POST['lastname']), $system->checkMagicQuotes($_POST['firstname']), $system->checkMagicQuotes($_POST['title']), $system->checkMagicQuotes($_POST['position']), $system->checkMagicQuotes($_POST['address']), $system->checkMagicQuotes($_POST['email']), $system->checkMagicQuotes($_POST['phone1']), $system->checkMagicQuotes($_POST['phone2']), $system->checkMagicQuotes($_POST['fax']), $_POST['lang'] ));
		break;
		/*case 'newContact':
