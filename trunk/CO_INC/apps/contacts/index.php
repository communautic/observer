...
if (!empty($_POST['request'])) {
	...
	switch ($_POST['request']) {
		...
		case 'setContactDetails':
			echo($contacts->setContactDetails($_POST['id'], $system->checkMagicQuotes($_POST['lastname']), $system->checkMagicQuotes($_POST['firstname']), $system->checkMagicQuotes($_POST['title']),$system->checkMagicQuotes($_POST['title2']), $system->checkMagicQuotes($_POST['company']), $system->checkMagicQuotes($_POST['position']), $system->checkMagicQuotes($_POST['email']), $system->checkMagicQuotes($_POST['email_alt']), $system->checkMagicQuotes($_POST['phone1']), $system->checkMagicQuotes($_POST['phone2']), $system->checkMagicQuotes($_POST['fax']), $system->checkMagicQuotes($_POST['website']), $system->checkMagicQuotes($_POST['address_line1']), $system->checkMagicQuotes($_POST['address_line2']), $system->checkMagicQuotes($_POST['address_town']), $system->checkMagicQuotes($_POST['address_postcode']), $system->checkMagicQuotes($_POST['address_country']), $_POST['gender'], $_POST['lang'], $_POST['timezone'], $system->checkMagicQuotes($_POST['bank_name']), $system->checkMagicQuotes($_POST['sort_code']), $system->checkMagicQuotes($_POST['account_number']), $system->checkMagicQuotes($_POST['bic']), $system->checkMagicQuotes($_POST['iban']), $system->checkMagicQuotes($_POST['vat_no']), $system->checkMagicQuotes($_POST['company_no']), $system->checkMagicQuotes($_POST['company_reg_loc']), $system->checkMagicQuotes($_POST['dvr']), $system->checkMagicQuotes($_POST['notes'])));
		break;
