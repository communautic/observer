	...
	<table width="530" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td style="width: 215px; padding: 6px 0;">
            <span class="bold" style="margin-left: 7px;"><?php echo $value->number;?>. <?php echo $lang["PATIENT_TREATMENT_GOALS_SINGUAL"];?></span><span class="text11"> (<?php echo $value->item_date;?>)</span></td>
