...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
	<tr>
		...
		<td><?php echo $lang["PROC_PROCS"];?></td>
	</tr>
</table>
</div>
...
<div style="position: absolute; top: 0px; width: 100%; height: 110px; background: #c8ffff; border-bottom: 1px solid #ccc;">
   ...
   <table border="0" cellspacing="0" cellpadding="0" style="margin-left: 141px;">
    <tr>
        ...
        <td width="158"><span style="color: #666; font-size: 11px; line-height: 30px; padding-left: 11px;">Initiative</span></td>
    ...
    <tr>
        ...
        <td><input name="enddate" type="text" id="archiveEndDate" value="" class="inlineDatepicker" />
        <span rel="0" id="calcFolder" class="inlineCheckbox coCheckbox inline" style="display: none;"></span>
        </td>
         <td><span id="archiveProcsSearch" class="bold"><em><span class="contentArrow"></span> Suchen</em></span></td>
    </tr>
</table>
</div>
<div id="archiveSearchResult" style="position: absolute; top: 140px; bottom: 0; left: 0; right: 0px; overflow: auto;"></div>
</div>
</div>
<div>
