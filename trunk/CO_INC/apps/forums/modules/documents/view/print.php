...
foreach($doc as $value) { ?>
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="standard">
        <tr>
            <td class="tcell-left">
            <?php if($i == 1) { echo $lang["FORUM_DOCUMENT_FILES"]; }?>&nbsp;
            </td>
            <td><?php echo $lang["FORUM_DOCUMENT_FILENAME"];?> <?php echo($value->filename);?></td>
        </tr>
        <tr>
            <td class="tcell-left">&nbsp;</td>
            <td><?php echo $lang["FORUM_DOCUMENT_FILESIZE"];?> <?php echo($value->filesize);?></td>
        </tr>
		<tr>
			 <td class="tcell-left">&nbsp;</td>
