...
<div id="forumsPost_<?php echo $child->id;?>" style="border-bottom: 1px solid #fff">
<table border="0" cellpadding="0" cellspacing="0" class="table-content grey" style="margin-bottom: 0px; border-collapse:separate;">
  <tr>
      ...
      <td class="tcell-right-posts">
       ...
       <td width="25" style="border-bottom: 1px solid #ccc;"><div class="togglePost" rel="<?php echo($child->id);?>"><span class="icon-toggle-post"></span></div></td>
       <?php if($perm) { ?><td width="25" style="border-bottom: 1px solid #ccc;"><a class="binItem<?php echo $postdellink;?>" rel="<?php echo $child->id;?>"><span class="<?php echo $postdelclass;?>"></span></a></td><?php } ?>
	</tr>
</table>
</div>