...
<?php foreach ($arr["phases"] as $phase) { ?>
	...
	<tr>
		<td class="tcell-left text11"><span><?php echo $lang["PRODUCTION_PHASE_TITLE"];?></span></td>
		<td class="tcell-right"><?php echo($phase->title);?></td>
        <td width="30"><a href="productions_phases" class="binRestore" rel="<?php echo $phase->id;?>"><span class="icon-restore"></span></a></td>
        <td width="30"><a href="productions_phases" class="binDelete" rel="<?php echo $phase->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left-inactive text11"><?php echo $lang["PRODUCTION_PHASE_TASK_MILESTONE"];?></td>
    <td class="tcell-right">&nbsp;</td>
    </tr>
</table>
<?php foreach ($arr["tasks"] as $task) { ?>
	...
	<tr>
		<td class="tcell-left text11"><span><?php echo $lang["PRODUCTION_PHASE_TASK_MILESTONE"];?></span></td>
		<td class="tcell-right"><?php echo($task->text);?></td>
        <td width="30"><a href="productions_phases" class="binRestoreItem" rel="<?php echo $task->id;?>"><span class="icon-restore"></span></a></td>
        <td width="30"><a href="productions_phases" class="binDeleteItem" rel="<?php echo $task->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
		<td class="tcell-left text11"><span><?php echo $lang["DELETED_BY_ON"];?></span></td>
