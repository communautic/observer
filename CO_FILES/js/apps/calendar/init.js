...
var eventSources=[
				  	{"url":"\/?path=apps\/calendar&request=getrequestedEvents&calendar_id=2","backgroundColor":"#63DA38","borderColor":"#888","textColor":"#000000","cache":true},
					...
					//{"url":"\/index.php\/apps\/calendar\/ajax\/events.php?calendar_id=6","backgroundColor":"#9fc6e7","borderColor":"#888","textColor":"#000000","cache":true},
					//{"url":"\/index.php\/apps\/calendar\/ajax\/events.php?calendar_id=shared_events","backgroundColor":"#1D2D44","borderColor":"#888","textColor":"white","editable":"false"}
				];
...
$(document).ready(function() {
		...
		var calendar = $('#calendar-right').fullCalendar({
			...
			select: function(start, end, allDay) {
            	...
            	$("#time-start").val($.fullCalendar.formatDate(start, 'hh:mmtt'));
            	$("#time-end").val($.fullCalendar.formatDate(end, 'hh:mmtt'));
			...
			/*[
        		'/?path=apps/calendar&request=getrequestedEvents'
    		]*/
			,
			timeFormat: {
