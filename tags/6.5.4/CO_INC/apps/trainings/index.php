...
if (!empty($_POST['request'])) {
	switch ($_POST['request']) {
		...
		case 'setTrainingDetails':
			...
			if(!isset($_POST['protocol1'])) { $_POST['protocol1'] = ''; }
			if(!isset($_POST['protocol2'])) { $_POST['protocol2'] = ''; }
			if(!isset($_POST['protocol3'])) { $_POST['protocol3'] = ''; }
			if(!isset($_POST['protocol4'])) { $_POST['protocol4'] = ''; }
			
			echo($trainings->setTrainingDetails($_POST['id'], $system->checkMagicQuotes($_POST['title']), $_POST['folder'], $_POST['management'], $system->checkMagicQuotes($_POST['management_ct']), $system->checkMagicQuotes($_POST['company']), $_POST['team'], $system->checkMagicQuotes($_POST['team_ct']), $system->checkMagicQuotes($_POST['trainer_details']), $_POST['training'], $_POST['training_id_orig'], $_POST['costs'], $_POST['registration_end'], $system->checkMagicQuotes($_POST['protocol']), $system->checkMagicQuotes($_POST['protocol1']), $system->checkMagicQuotes($_POST['protocol2']), $system->checkMagicQuotes($_POST['protocol3']), $system->checkMagicQuotes($_POST['protocol4']), $_POST['date1'], $_POST['date2'], $_POST['date3'], $_POST['time1'], $_POST['time2'], $_POST['time3'], $_POST['time4'], $_POST['place1'], $system->checkMagicQuotes($_POST['place1_ct']), $_POST['place2'], $system->checkMagicQuotes($_POST['place2_ct']), $system->checkMagicQuotes($_POST['text1']), $system->checkMagicQuotes($_POST['text2']), $system->checkMagicQuotes($_POST['text3'])));
		break;
		case 'moveTraining':
