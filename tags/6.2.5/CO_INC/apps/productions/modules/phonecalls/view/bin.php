...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left-inactive text11"><?php echo $lang["PRODUCTION_PHONECALLS"];?></td>
...
<?php foreach ($arr["phonecalls"] as $phonecall) { ?>
	...
	<tr>
		<td class="tcell-left text11"><span><?php echo $lang["PRODUCTION_PHONECALL_TITLE"];?></span></td>
		<td class="tcell-right"><?php echo($phonecall->title);?></td>
        <td width="30"><a href="productions_phonecalls" class="binRestore" rel="<?php echo $phonecall->id;?>"><span class="icon-restore"></span></a></td>
        <td width="30"><a href="productions_phonecalls" class="binDelete" rel="<?php echo $phonecall->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left-inactive text11"><?php echo $lang["PRODUCTION_PHONECALL_GOALS"];?></td>
    <td class="tcell-right">&nbsp;</td>
    </tr>
</table>
<?php foreach ($arr["phonecalls_tasks"] as $phonecall_task) { ?>
	...
	<tr>
        ...
        <td width="30"><a href="productions_phonecalls" class="binRestoreItem" rel="<?php echo $phonecall_task->id;?>"><span class="icon-restore"></span></a></td>
        <td width="30"><a href="productions_phonecalls" class="binDeleteItem" rel="<?php echo $phonecall_task->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
		<td class="tcell-left text11"><span><?php echo $lang["DELETED_BY_ON"];?></span></td>
