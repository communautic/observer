<table width="100%" class="title">
	<tr>
        <td class="tcell-left"><?php echo $lang["PRODUCTION_PHASE_TITLE"];?></td>
...
<table width="100%" class="standard">
    <tr>
	  <td class="tcell-left"><?php echo $lang["PRODUCTION_PHASE_TEAM"];?></td>
...
foreach($task as $value) { 
    ...
    <table width="100%" class="fourCols">
        <tr>
            <td class="fourCols-one"><?php if($i == 1) { echo $lang["PRODUCTION_PHASE_TASK_MILESTONE"]; }?>&nbsp;</td>
        ...
        <tr>
            ...
            <td class="fourCols-two">&nbsp;</td>
            <td class="fourCols-three">&nbsp;</td>
            <td class="grey smalltext"><?php echo $lang["PRODUCTION_PHASE_TASK_TEAM"];?> <?php echo($value->team . " " . $value->team_ct);?></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td class="fourCols-two">&nbsp;</td>
            <td class="fourCols-three">&nbsp;</td>
            <td class="grey smalltext"><?php echo $lang["PRODUCTION_PHASE_TASK_DEPENDENT"];?> <?php echo($value->dependent_title);?></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td class="fourCols-two">&nbsp;</td>
            <td class="fourCols-three">&nbsp;</td>
            <td class="grey smalltext"><?php echo $lang["PRODUCTION_STATUS_FINISHED"];?> <?php echo($donedate);?></td>
        </tr>
        <?php } ?>
    ...
    <?php } else { // milestone ?>
        ...
        <tr>
            ...
            <td class="fourCols-two">&nbsp;</td>
            <td class="fourCols-three">&nbsp;</td>
            <td class="grey smalltext fourCols-paddingTop"><?php echo $lang["PRODUCTION_PHASE_MILESTONE_DATE"];?> <?php echo($value->startdate);?></td>
        </tr>
        <?php if(!empty($value->dependent_title)) { ?>
        <tr>
            <td class="fourCols-one">&nbsp;</td>
