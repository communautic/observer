...
<?php foreach ($arr["menues"] as $menue) { ?>
	...
	<tr>
        ...
        <td width="30"><a href="publishers_menues" class="binRestore" rel="<?php echo $menue->id;?>"><span class="icon-restore"></span></a></td>
        <td width="30"><a href="publishers_menues" class="binDelete" rel="<?php echo $menue->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<?php foreach ($arr["menues_tasks"] as $menue_task) { ?>
	...
	<tr>
        ...
        <td width="30"><a href="publishers_menues" class="binRestoreItem" rel="<?php echo $menue_task->id;?>"><span class="icon-restore"></span></a></td>
        <td width="30"><a href="publishers_menues" class="binDeleteItem" rel="<?php echo $menue_task->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
		<td class="tcell-left text11"><span><?php echo $lang["DELETED_BY_ON"];?></span></td>
