...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
  <tr>
    <td class="tcell-left text11"><span class="<?php if($vdoc->canedit) { ?>content-nav focusTitle<?php } ?>"><span><?php echo $lang["EVAL_VDOC_TITLE"];?></span></span></td>
...
<textarea id="evalsvdocContent" name="content" class="vdoc initVdocs" style="width: 635px; height: 400px; visibility:hidden" ><?php echo($vdoc->content);?></textarea>
<?php } else { ?>
...
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
	  <td class="tcell-left text11"><span class="<?php if($vdoc->canedit) { ?>content-nav showDialog<?php } ?>" request="getAccessDialog" field="evalsvdoc_access" title="<?php echo $lang["GLOBAL_ACCESS"];?>" append="1"><span><?php echo $lang["GLOBAL_ACCESS"];?></span></span></td>
        <td class="tcell-right"><div id="evalsvdoc_access" class="itemlist-field"><div class="listmember" field="evalsvdoc_access" uid="<?php echo($vdoc->access);?>" style="float: left"><?php echo($vdoc->access_text);?></div></div><input type="hidden" name="vdoc_access_orig" value="<?php echo($vdoc->access);?>" /></td>
	</tr>
</table>
<div class="content-spacer"></div>
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		...
		<td class="tcell-right-inactive tcell-right-nopadding"><div id="evalsvdoc_sendto">
        <?php 
