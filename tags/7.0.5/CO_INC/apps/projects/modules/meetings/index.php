...
if (!empty($_GET['request'])) {
	switch ($_GET['request']) {
		...
		break;
		case 'sortItems':
			echo($projectsMeetings->sortItems($_GET['task']));
		break;
		...
		break;
		case 'newCheckpoint':
			echo($projectsMeetings->newCheckpoint($_GET['id'],$_GET['date']));
		break;
		case 'updateCheckpoint':
			echo($projectsMeetings->updateCheckpoint($_GET['id'],$_GET['date']));
		break;
		case 'deleteCheckpoint':
			echo($projectsMeetings->deleteCheckpoint($_GET['id']));
		break;
		case 'updateStatus':
...
if (!empty($_POST['request'])) {
	...
	switch ($_POST['request']) {
		...
		case 'updateCheckpointText':
			echo($projectsMeetings->updateCheckpointText($_POST['id'],$system->checkMagicQuotes($_POST['text'])));
		break;
	}
}
