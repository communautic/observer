...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
  <tr>
    <td class="tcell-left text11"><span><span><?php echo $lang["PROJECT_PHASE_TITLE"];?></span></span></td>
	<td width="20"><div class="bold"><?php echo($phase->num) ;?>.</div></td>
    <td><div class="textarea-title"><?php echo($phase->title);?></div></td>
  </tr>
  <tr class="table-title-status">
    ...
    <td colspan="2"><div class="statusTabs">
    	<ul>
        	<li><span class="left planned<?php echo $phase->status_planned_active;?>" rel="0" reltext="<?php echo $lang["GLOBAL_STATUS_PLANNED_TIME"];?>"><?php echo $lang["GLOBAL_STATUS_PLANNED"];?></span></li>
            <li><span class=" inprogress<?php echo $phase->status_inprogress_active;?>" rel="1" reltext="<?php echo $lang["GLOBAL_STATUS_INPROGRESS_TIME"];?>"><?php echo $lang["GLOBAL_STATUS_INPROGRESS"];?></span></li>
            <li><span class="right statusButton finished<?php echo $phase->status_finished_active;?>" rel="2" reltext="<?php echo $lang["GLOBAL_STATUS_FINISHED_TIME"];?>"><?php echo $lang["GLOBAL_STATUS_FINISHED"];?></span></li>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
  <tr>
    <td class="tcell-left text11"><span request="getContactsDialog" field="projectsteam" append="1"><span><?php echo $lang["PROJECT_PHASE_TEAM"];?></span></span></td>
