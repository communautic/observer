...
<?php foreach ($arr["comments"] as $comment) { ?>
	...
	<tr>
        ...
        <td width="25"><a href="employees_comments" class="binRestore" rel="<?php echo $comment->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="employees_comments" class="binDelete" rel="<?php echo $comment->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<?php foreach ($arr["comments_tasks"] as $comment_task) { ?>
	...
	<tr>
        ...
        <td width="25"><a href="employees_comments" class="binRestoreItem" rel="<?php echo $comment_task->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="employees_comments" class="binDeleteItem" rel="<?php echo $comment_task->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
		<td class="tcell-left text11"><span><?php echo $lang["DELETED_BY_ON"];?></span></td>
