...
<?php foreach ($arr["phonecalls"] as $phonecall) { ?>
	...
	<tr>
        ...
        <td width="30"><a href="complaints_phonecalls" class="binRestore" rel="<?php echo $phonecall->id;?>"><span class="icon-restore"></span></a></td>
        <td width="30"><a href="complaints_phonecalls" class="binDelete" rel="<?php echo $phonecall->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<?php foreach ($arr["phonecalls_tasks"] as $phonecall_task) { ?>
	...
	<tr>
        ...
        <td width="30"><a href="complaints_phonecalls" class="binRestoreItem" rel="<?php echo $phonecall_task->id;?>"><span class="icon-restore"></span></a></td>
        <td width="30"><a href="complaints_phonecalls" class="binDeleteItem" rel="<?php echo $phonecall_task->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
		<td class="tcell-left text11"><span><?php echo $lang["DELETED_BY_ON"];?></span></td>
