...
<table border="0" cellpadding="0" cellspacing="0" class="table-content tbl-inactive" style="margin-bottom: 0px;">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="12"></td>
      <td class="tcell-left text11"><span class="<?php if($phase->canedit) { ?>content-nav ui-datepicker-trigger-action<?php } ?>"><span><?php echo $lang["PRODUCTION_PHASE_TASK_START"];?></span></span></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td class="tcell-left text11"><span class="<?php if($phase->canedit) { ?>content-nav ui-datepicker-trigger-action<?php } ?>"><span><?php echo $lang["PRODUCTION_PHASE_TASK_END"];?></span></span></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td class="tcell-left text11"><span class="<?php if($phase->canedit) { ?>content-nav showDialog<?php } ?>" request="getContactsDialog" field="task_team_<?php echo $value->id;?>" append="1"><span><?php echo $lang["PRODUCTION_PHASE_TASK_TEAM"];?></span></span></td>
    ...
    <tr>
      <td width="12">&nbsp;</td>
      <td class="tcell-left text11"><span class="<?php if($phase->canedit) { ?>content-nav ui-datepicker-trigger-action<?php } ?>"><span><?php echo $lang["PRODUCTION_STATUS_FINISHED"];?></span></span></td>
