<div id="employees" class="app">
<input name="employees-current" id="employees-current" type="hidden" value="" />
...
<?php include(CO_INC . "/view/logo.php"); ?>
	<div id="employees1-outer" class="firstLevelOuter">
    <h3 class="module-bg-active"><?php echo $lang["EMPLOYEE_FOLDER"];?></h3>
    <div id="employees1" class="gradient module-bg-active">
	...
	<div id="employees2-outer" class="secondLevelOuter">
		<h3><?php echo $lang["EMPLOYEE_EMPLOYEES"];?></h3>
        <div id="employees2" class="gradient">
            <div class="module-actions"><div class="sort-outer"><span class="sort" rel="1"></span></div></div>
            <div class="module-inner west-ui-content">
            <div class="scrolling-content">
            <ul class="sortable"><li></li></ul>
	...
	<div id="employees3-outer" class="thirdLevelOuter">
		<div id="employees3">
        	<?php 
				$i = 0;
				foreach($employees->modules as $module  => $value) {
					...
					?>
                    <div id="employees_<?php echo($module);?>" class="thirdLevel" style="top: <?php echo($i*27);?>px">
                        <div class="module-actions module-actions-modules"><?php if (${'employees_'.$module.'_filter'} != 0) { ?><div class="sort-outer"><span class="sort" rel="1"></span></div><?php } ?></div>
                        <h3 rel="<?php echo($module);?>"><?php echo(${'employees_'.$module.'_name'});?></h3>
                        <div class="numItems" id="<?php echo('employees_'.$module.'_items');?>"></div>
                        <div class="employees3-content"><div class="scrolling-content">        
...
<div class="ui-layout-center">
    <div class="center-north">
    	...
    	<div id="app-top">
    	<div id="employees-top" class="titles">
	...
	<div class="center-west">
		<ul id="employeesActions" class="ui-layout-content actionconsole">
            ...
            <li class="listHandbook"><span class="actionHandbook" title="<?php echo $lang["EMPLOYEE_HANDBOOK"];?>"></span></li>
	...
	<div class="center-center" id="employees-right"></div>
</div>
<div id="modalDialogEmployeesCreateExcel" title="Excel Export"></div>
</div>