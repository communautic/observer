...
<?php include(CO_INC . "/view/logo.php"); ?>	
    ...
    <div class="center-north">
        ...
        <div class="globalsearch">
        	<input class="globalSearch ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true" rel="contacts"><div class="global-search-outer"></div>
        </div>
    </div>
