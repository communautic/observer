...
<div style="position: absolute; top: 70px; width: 100%; height: 60px; background: #d2dcff; border-bottom: 1px solid #ccc;">
   <table border="0" cellspacing="0" cellpadding="0" style="margin-left: 141px;">
    ...
    <tr>
        <td><input id="calcWhoField" name="who" type="text" class="inlineSearch" rel="patients" /><input name="who" type="hidden" id="calcWho" value="0" /></td>
        ...
        <td><span rel="0" id="calcFolder" class="inlineCheckbox coCheckbox inline"></span></td>
