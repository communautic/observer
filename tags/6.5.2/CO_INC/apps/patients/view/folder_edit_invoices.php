...
<?php
    ...
    <td width="145" class="row<?php  echo ($i % 2);?>" style="padding-left: 14px;"><?php echo($invoice->invoice_date);?></td>
    <td width="132" class="row<?php  echo ($i % 2);?>"><?php echo(CO_DEFAULT_CURRENCY . ' ' . $invoice->totalcosts);?></td>
