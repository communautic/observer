/* access Object */
function complaintsAccess(name) {
	this.name = name;
	...
	this.getDetails = function(moduleidx,liindex,list) {
		...
		$.ajax({ type: "GET", url: "/", data: "path=apps/complaints/modules/access&request=getDetails&id="+id, success: function(html){
			$("#complaints-right").html(html);
	...
	this.actionRefresh = function() {
		$("#complaints3 ul[rel=access] .active-link").trigger("click");
	}
	...
	this.actionHelp = function() {
		var url = "/?path=apps/complaints/modules/access&request=getHelp";
		$("#documentloader").attr('src', url);
	}
	
}

var complaints_access = new complaintsAccess('complaints_access');