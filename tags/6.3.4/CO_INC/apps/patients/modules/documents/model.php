...
class PatientsDocumentsModel extends PatientsModel {
   ...
   function setDetails($id,$title,$document_access) {
		...
		$q = "UPDATE " . CO_TBL_PATIENTS_DOCUMENTS_FOLDERS . " set title = '$title', access='$document_access', access_date='$access_date', access_user = '$session->uid', edited_user = '$session->uid', edited_date = '$now' where id='$id'";
		$result = mysql_query($q, $this->_db->connection);
