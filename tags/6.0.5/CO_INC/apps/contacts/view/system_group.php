...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
	<tr>
		<td class="tcell-left text11"><span class="content-nav-title"><?php echo $lang['CONTACTS_GROUP_TITLE'];?></span></td>
...
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
  <tr>
    ...
    <td class="tcell-right-inactive"><?php echo($group->allcontacts);?>&nbsp;</td>
  </tr>
</table>
