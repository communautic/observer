...
if(is_array($reminders)) {
	...
	foreach ($reminders as $reminder) { ?>
		<div><div class="widgetItemOuter Read calendarLinkRead" rel="<?php echo $reminder->uid . ',' . $reminder->linkyear . ',' . $reminder->linkmonth . ',' . $reminder->linkday;?>"><div class="widgetItemTitle"><div class="widgetIconReminder"></div>
    <?php
