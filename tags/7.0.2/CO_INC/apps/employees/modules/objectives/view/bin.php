...
<?php foreach ($arr["objectives"] as $objective) { ?>
	...
	<tr>
        ...
        <td width="25"><a href="employees_objectives" class="binRestore" rel="<?php echo $objective->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="employees_objectives" class="binDelete" rel="<?php echo $objective->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<?php foreach ($arr["objectives_tasks"] as $objective_task) { ?>
	...
	<tr>
        ...
        <td width="25"><a href="employees_objectives" class="binRestoreItem" rel="<?php echo $objective_task->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="employees_objectives" class="binDeleteItem" rel="<?php echo $objective_task->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
		<td class="tcell-left text11"><span><?php echo $lang["DELETED_BY_ON"];?></span></td>
