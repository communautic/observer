...
<table border="0" cellpadding="0" cellspacing="0" class="table-content tbl-inactive">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>&nbsp;</td>
      <td class="tcell-left text11"><a href="#" class="content-nav ui-datepicker-trigger-action"><span><?php echo $lang["PHASE_TASK_END"];?></span></a></td>
    ...
    <tr>
      <td width="12">&nbsp;</td>
      <td class="tcell-left text11"><a href="#" class="content-nav ui-datepicker-trigger-action"><span><?php echo $lang["PROJECT_STATUS_FINISHED"];?></span></a></td>
