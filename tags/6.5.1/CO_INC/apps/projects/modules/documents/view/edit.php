...
<table border="0" cellpadding="0" cellspacing="0" class="table-content tbl-protocol">
  <tr>
    <td class="tcell-left text11"><span class="<?php if($document->canedit) { ?>content-nav selectTextarea<?php } ?>"><span><?php echo $lang["PROJECT_DOCUMENT_DESCRIPTION"];?></span></span></td>
...
<div id="projects_documents_uploader" class="document-uploader">		
	<noscript>			
