...
function getTrainingTitleFromMeetingIDs($array,$target, $link = 0){
   ...
   * get details for the training folder
   */
   function setTrainingDetails($id,$title,$folder,$management,$management_ct,$company,$team,$team_ct,$trainer_details,$training,$costs,$registration_end,$protocol,$protocol1,$protocol2,$protocol3,$protocol4,$date1,$date2,$date3,$time1,$time2,$time3,$time4,$place1,$place1_ct,$place2,$place2_ct,$text1,$text2,$text3) {
		...
		$q = "UPDATE " . CO_TBL_TRAININGS . " set title = '$title', folder = '$folder', management = '$management', management_ct = '$management_ct', company='$company', team='$team', team_ct = '$team_ct' , trainer_details ='$trainer_details', training = '$training', costs='$costs', protocol='$protocol', protocol1='$protocol1', protocol2='$protocol2', protocol3='$protocol3', protocol4='$protocol4',$sql place1 = '$place1', place1_ct = '$place1_ct', place2 = '$place2', place2_ct = '$place2_ct', text1 = '$text1', text2 = '$text2', text3 = '$text3', edited_user = '$session->uid', edited_date = '$now' where id='$id'";
		$result = mysql_query($q, $this->_db->connection);
   ...
   function updateStatus($id,$date,$status) {
	...
	function createDuplicate($id) {
		...
		$now = gmdate("Y-m-d H:i:s");
		// training
		$q = "INSERT INTO " . CO_TBL_TRAININGS . " (folder,title,management,company,team,training,costs,registration_end,protocol,protocol1,protocol2,protocol3,protocol4,date1,date2,date3,time1,time2,time3,time4,place1,place1_ct,place2,place2_ct,text1,text2,text3,planned_date,created_date,created_user,edited_date,edited_user) SELECT folder,CONCAT(title,' ".$lang["GLOBAL_DUPLICAT"]."'),management,company,team,training,costs,registration_end,protocol,protocol1,protocol2,protocol3,protocol4,date1,date2,date3,time1,time2,time3,time4,place1,place1_ct,place2,place2_ct,text1,text2,text3,'$now','$now','$session->uid','$now','$session->uid' FROM " . CO_TBL_TRAININGS . " where id='$id'";
