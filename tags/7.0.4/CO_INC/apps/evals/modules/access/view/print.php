<table border="0" cellpadding="0" cellspacing="0" width="100%" class="grey">
	<tr>
        <td class="tcell-left"><?php echo $lang["EVAL_MEETING_TITLE"];?></td>
        <td><strong><?php echo($meeting->title);?></strong></td>
	</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="standard">
	<tr>
		<td class="tcell-left"><?php echo $lang["EVAL_MEETING_DATE"];?></td>
		<td><?php echo($meeting->meeting_date)?></td>
    </tr>
	<tr>
	  <td class="tcell-left"><?php echo $lang["EVAL_MEETING_TIME_START"];?></td>
        <td><?php echo($meeting->start);?></td>
	</tr>
	<tr>
	  <td class="tcell-left"><?php echo $lang["EVAL_MEETING_TIME_END"];?></td>
        <td><?php echo($meeting->end);?></td>
	</tr>
    <tr>
	  <td class="tcell-left"><?php echo $lang["EVAL_MEETING_PLACE"];?></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="standard">
	<tr>
		<td class="tcell-left"><?php echo $lang["EVAL_MEETING_ATTENDEES"];?></td>
		<td><?php echo($meeting->participants)?></td>
    </tr>
	<tr>
	  <td class="tcell-left"><?php echo $lang["EVAL_MEETING_MANAGEMENT"];?></td>
...
foreach($task as $value) { 
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="standard">
        <tr>
            <td class="tcell-left-short"><?php if($i == 1) { echo $lang["EVAL_MEETING_GOALS"]; }?>&nbsp;</td>
