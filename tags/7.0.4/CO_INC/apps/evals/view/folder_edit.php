...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
	<tr>
		<td class="tcell-left text11"><span class="<?php if($folder->canedit) { ?>content-nav focusTitle<?php } ?>"><span><?php echo $lang["EVAL_FOLDER"];?></span></span></td>
...
<input name="evalstatus" type="hidden" value="0" />
</form>
<?php } ?>
...
if(is_array($evals)) {
	...
	?>
    <div class="loadEval listOuter"  rel="<?php echo($eval->id);?>">
    <div class="bold co-link listTitle"><?php echo($eval->title);?></div>
    <div class="text11 listText"><div><?php echo($eval->status_text . " " . $eval->status_text_time . " " . $eval->status_date);?></div></div>
    </div>
    <?php 
	}
}
