<table width="100%" class="title">
	<tr>
        <td class="tcell-left"><?php echo $lang["CLIENT_PHONECALL_TITLE"];?></td>
        <td><strong><?php echo($phonecall->title);?></strong></td>
	</tr>
</table>
<table width="100%" class="standard">
	<tr>
		<td class="tcell-left"><?php echo $lang["CLIENT_PHONECALL_DATE"];?></td>
		<td><?php echo($phonecall->item_date)?></td>
    </tr>
</table>
<table width="100%" class="standard">
	<tr>
	  <td class="tcell-left"><?php echo $lang["CLIENT_PHONECALL_TIME_START"];?></td>
        <td><?php echo($phonecall->start);?></td>
	</tr>
</table>
<table width="100%" class="standard">
	<tr>
	  <td class="tcell-left"><?php echo $lang["CLIENT_PHONECALL_TIME_END"];?></td>
...
<table width="100%" class="standard">
	<tr>
	  <td class="tcell-left"><?php echo $lang["CLIENT_PHONECALL_MANAGEMENT"];?></td>
...
<table width="100%" class="protocol">
	<tr>
        <td class="tcell-left top"><?php echo $lang["CLIENT_PHONECALL_GOALS"];?></td>
