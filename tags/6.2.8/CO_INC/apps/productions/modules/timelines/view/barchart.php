...
<div  class="barchart-outer" style="position: relative; font-size: 11px; width: <?php echo($production["css_width"]+225);?>px; height:<?php echo($production["css_height"]+50);?>px">
    ...
    <div id="barchart-container-left" style="position: absolute; z-index: 5; width: 220px; padding-top: 37px; background-color:#FFF; height:<?php echo($production["css_height"]-5+16);?>px">
	...
	<div style="position: relative; padding-left: 10px; height: 16px; margin: 0 10px 2px 0; background-color:#e5e5e5"><a class="but-scroll-to" t="0" l="0"><?php echo $lang['PRODUCTION_KICKOFF'];?></a>
...
<div id="barchart-container-right" style="margin-left: 225px; width: <?php echo($production["css_width"]);?>px;">
    ...
    <div style="position: relative; background-image:url(<?php echo($production["bg_image"]);?>); background-position: <?php echo($production["bg_image_shift"]);?>px 0px; width: <?php echo($production["css_width"]);?>px; height:<?php echo($production["css_height"]);?>px;">
			<!-- kick off -->
<div class="coTooltip loadProduction" rel="<?php echo($pid);?>" style="z-index: 2; position: absolute; top: 5px; left: <?php echo(round($production["td_width"]/2)-8);?>px; height: 16px; width: 16px;"><img src="<?php echo CO_FILES;?>/img/kickoff.png" width="16" height="16" alt="" />            	<div class="coTooltipHtml" style="display: none">
					Kick off<br />
