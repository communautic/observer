...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
  <tr>
    ...
    <td><div class="textarea-title"><?php echo($meeting->title);?></div></td>
  </tr>
...
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
		<td class="tcell-left text11"><span class="<?php if($meeting->canedit) { ?>content-nav showDialogTime<?php } ?>" rel="projectsmeetingstart"><span><?php echo $lang["PROC_MEETING_TIME_START"];?></span></span></td>
		<td class="tcell-right"><div id="projectsmeetingstart" class="itemlist-field"><?php echo($meeting->start);?></div></td>
	</tr>
</table>
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
		<td class="tcell-left text11"><span class="<?php if($meeting->canedit) { ?>content-nav showDialogTime<?php } ?>" rel="projectsmeetingend"><span><?php echo $lang["PROC_MEETING_TIME_END"];?></span></span></td>
		<td class="tcell-right"><div id="projectsmeetingend" class="itemlist-field"><?php echo($meeting->end);?></div></td>
	</tr>
</table>
<table border="0" cellspacing="0" cellpadding="0" class="table-content">
	<tr>
		<td class="tcell-left text11"><span class="<?php if($meeting->canedit) { ?>content-nav showDialog<?php } ?>" request="getContactsDialogPlace" field="projectslocation" append="0"><span><?php echo $lang["PROC_MEETING_PLACE"];?></span></span></td>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left text11"><span href="#" class="<?php if($meeting->canedit) { ?>content-nav showDialog<?php } ?>" request="getContactsDialog" field="projectsparticipants" append="1"><span><?php echo $lang["PROC_MEETING_ATTENDEES"];?></span></span></td>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left text11"><span class="<?php if($meeting->canedit) { ?>content-nav showDialog<?php } ?>" request="getContactsDialog" field="projectsmanagement" append="1"><span><?php echo $lang["PROC_MEETING_MANAGEMENT"];?></span></span></td>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
  <tr>
    <td class="tcell-left text11"><span class="<?php if($meeting->canedit) { ?>content-nav showDialog<?php } ?>" request="getDocumentsDialog" field="projectsdocuments" append="1"><span><?php echo $lang["PROC_DOCUMENT_DOCUMENTS"];?></span></span></td>
