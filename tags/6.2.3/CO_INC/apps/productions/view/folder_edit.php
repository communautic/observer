...
<table border="0" cellpadding="0" cellspacing="0" class="table-title">
	<tr>
		<td class="tcell-left text11"><span class="<?php if($folder->canedit) { ?>content-nav focusTitle<?php } ?>"><span><?php echo $lang["PRODUCTION_FOLDER"];?></span></span></td>
...
<input name="productionstatus" type="hidden" value="0" />
</form>
  ...
  <tr>
    ...
    <td  class="tcell-right">
      <table  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="23" valign="top"><input name="productionstatus" type="radio" value="0"<?php //echo($active);?> class="jNiceHidden" />
          </td>
          <td width="70" valign="top"><?php echo $lang["PRODUCTION_FOLDER_STATUS_ACTIVE"];?></td>
          <td width="23" valign="top"><input name="productionstatus" type="radio" value="1"<?php //echo($archiv);?> class="jNiceHidden" /></td>
          <td valign="top"><?php echo $lang["PRODUCTION_FOLDER_STATUS_ARCHIVE"];?></td>
        </tr>
      </table>
    </td>
  </tr>
