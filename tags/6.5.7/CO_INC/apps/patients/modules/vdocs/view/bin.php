...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left-inactive text11"><?php echo $lang["PATIENT_VDOC_VDOCS"];?></td>
...
<?php foreach ($arr["vdocs"] as $vdoc) { ?>
	...
	<tr>
		<td class="tcell-left text11"><span><?php echo $lang["PATIENT_VDOC_TITLE"];?></span></td>
		<td class="tcell-right"><?php echo($vdoc->title);?></td>
        <td width="25"><a href="patients_vdocs" class="binRestore" rel="<?php echo $vdoc->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="patients_vdocs" class="binDelete" rel="<?php echo $vdoc->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="table-content">
	<tr>
		<td class="tcell-left-inactive text11"><?php echo $lang["PATIENT_VDOC_GOALS"];?></td>
    <td class="tcell-right">&nbsp;</td>
    </tr>
</table>
