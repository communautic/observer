...
<?php foreach ($arr["documents_folders"] as $documents_folder) { ?>
	...
	<tr>
        ...
        <td width="25"><a href="complaints_documents" class="binRestore" rel="<?php echo $documents_folder->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="complaints_documents" class="binDelete" rel="<?php echo $documents_folder->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
...
<?php foreach ($arr["files"] as $file) { ?>
	...
	<tr>
        ...
        <td width="25"><a href="complaints_documents" class="binRestoreItem" rel="<?php echo $file->id;?>"><span class="icon-restore"></span></a></td>
        <td width="25"><a href="complaints_documents" class="binDeleteItem" rel="<?php echo $file->id;?>"><span class="icon-delete"></span></a></td>
	</tr>
    <tr>
		<td class="tcell-left text11"><span><?php echo $lang["DELETED_BY_ON"];?></span></td>
